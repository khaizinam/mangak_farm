var Ie=Object.defineProperty;var Ee=(e,t,n)=>t in e?Ie(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var o=(e,t,n)=>Ee(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const ht="spring",ft="summer",mt="autumn",gt="winter",Me={SPRING:ht,SUMMER:ft,AUTUMN:mt,WINTER:gt},je=[ht,ft,mt,gt],Le={[ht]:"🌸 Xuân",[ft]:"☀️ Hạ",[mt]:"🍂 Thu",[gt]:"❄️ Đông"};window.SEASON_SPRING=ht;window.SEASON_SUMMER=ft;window.SEASON_AUTUMN=mt;window.SEASON_WINTER=gt;window.SEASON=Me;window.SEASONS=je;window.SEASON_LABELS=Le;class v{constructor(t={}){this.plot_key=t.plot_key||"",this.plant_id=t.plant_id||this.constructor.id,this.status=typeof t.status=="number"?t.status:0,this.planted_at=t.planted_at||Date.now(),this.is_wrong_season=typeof t.is_wrong_season=="boolean"?t.is_wrong_season:!1,this.fertilizer_type=typeof t.fertilizer_type=="number"?t.fertilizer_type:0,this.current_water=typeof t.current_water=="number"?t.current_water:0,this.last_watered_at=t.last_watered_at||null,this.bug_started_at=t.bug_started_at||null,this.pesticide_until=t.pesticide_until||null,this.lost_yield_by_water=typeof t.lost_yield_by_water=="number"?t.lost_yield_by_water:0,this.lost_yield_by_bug=typeof t.lost_yield_by_bug=="number"?t.lost_yield_by_bug:0,this.last_calculated_at=t.last_calculated_at||Date.now(),this.grown_ms=typeof t.grown_ms=="number"?t.grown_ms:0,this.rot_ms=typeof t.rot_ms=="number"?t.rot_ms:0}get id(){return this.constructor.id}get name(){return this.constructor.name}get season(){return this.constructor.season}get buy_price(){return this.constructor.buy_price}get sell_price_per_yield(){return this.constructor.sell_price_per_yield}get base_yield(){return this.constructor.base_yield}get growth_time(){return this.constructor.growth_time}get rot_time(){return this.constructor.rot_time}get water_consume_per_hour(){return this.constructor.water_consume_per_hour}get drought_penalty_per_hour(){return this.constructor.drought_penalty_per_hour}get bug_penalty_per_hour(){return this.constructor.bug_penalty_per_hour}get emoji(){return this.constructor.emoji}toJSON(){return{plot_key:this.plot_key,plant_id:this.plant_id,status:this.status,planted_at:this.planted_at,is_wrong_season:this.is_wrong_season,fertilizer_type:this.fertilizer_type,current_water:this.current_water,last_watered_at:this.last_watered_at,bug_started_at:this.bug_started_at,pesticide_until:this.pesticide_until,lost_yield_by_water:this.lost_yield_by_water,lost_yield_by_bug:this.lost_yield_by_bug,last_calculated_at:this.last_calculated_at,grown_ms:this.grown_ms,rot_ms:this.rot_ms}}calcGrossYield(){var s;const t=this.is_wrong_season?.5:1,n=((s=window.FERTILIZER_DATA&&window.FERTILIZER_DATA[this.fertilizer_type])==null?void 0:s.multiplier)||1;return Math.round(this.base_yield*t*n)}calcNetYield(){const t=this.calcGrossYield(),n=t*.6,s=Math.min(n,this.lost_yield_by_bug),i=this.lost_yield_by_water+s;return Math.max(1,t-Math.floor(i))}lazyUpdate(t=Date.now()){var d;const n=t-this.last_calculated_at;if(n<=0)return this;const s=this.growth_time*6e4*(((d=window.FERTILIZER_DATA&&window.FERTILIZER_DATA[this.fertilizer_type])==null?void 0:d.time_multiplier)||1);let i=0;const a=this.calcGrossYield();if(this.status===0){const u=s-this.grown_ms,c=this.water_consume_per_hour>0?this.current_water/this.water_consume_per_hour*36e5:1/0;i=Math.min(n,c,u),i<0&&(i=0);const p=i/36e5;if(this.water_consume_per_hour>0&&(this.current_water=Math.max(0,this.current_water-this.water_consume_per_hour*p)),i>0){if(this.bug_started_at){const f=this.pesticide_until&&this.pesticide_until>this.last_calculated_at;let _=0;f?this.pesticide_until<this.last_calculated_at+i&&(_=(this.last_calculated_at+i-this.pesticide_until)/36e5):_=p,this.lost_yield_by_bug+=_*this.base_yield*this.bug_penalty_per_hour;const m=a*.6;this.lost_yield_by_bug>m&&(this.lost_yield_by_bug=m)}if(!this.bug_started_at&&(!this.pesticide_until||this.pesticide_until<t)){const f=1-Math.pow(.7,p);Math.random()<f&&(this.bug_started_at=this.last_calculated_at+Math.random()*i)}}if(this.grown_ms+=i,this.grown_ms>=s){this.status=1,this.bug_started_at=null;const f=n-i;f>0&&(this.rot_ms+=f)}}else this.status===1&&(this.rot_ms+=n);return this.status===1&&this.rot_ms>=this.rot_time*6e4&&(this.status=2),a-this.lost_yield_by_water-this.lost_yield_by_bug<=0&&this.status!==2&&(this.status=2),this.last_calculated_at=t,this}}let De=class{constructor(t={}){this.zone=typeof t.zone=="number"?t.zone:0,this.index=typeof t.index=="number"?t.index:0,this.locked=typeof t.locked=="boolean"?t.locked:!0}toJSON(){return{zone:this.zone,index:this.index,locked:this.locked}}};class S extends v{}o(S,"id","p01"),o(S,"name","Dâu tây"),o(S,"season",SEASON_SPRING),o(S,"buy_price",30),o(S,"sell_price_per_yield",5),o(S,"base_yield",9),o(S,"growth_time",15),o(S,"rot_time",1440),o(S,"water_consume_per_hour",16.67),o(S,"drought_penalty_per_hour",.05),o(S,"bug_penalty_per_hour",.03),o(S,"emoji","🍓");class $ extends v{}o($,"id","p02"),o($,"name","Cải xanh"),o($,"season",SEASON_SPRING),o($,"buy_price",200),o($,"sell_price_per_yield",9),o($,"base_yield",40),o($,"growth_time",360),o($,"rot_time",1440),o($,"water_consume_per_hour",16.67),o($,"drought_penalty_per_hour",.05),o($,"bug_penalty_per_hour",.03),o($,"emoji","🥬");class k extends v{}o(k,"id","p03"),o(k,"name","Hoa tulip"),o(k,"season",SEASON_SPRING),o(k,"buy_price",600),o(k,"sell_price_per_yield",12),o(k,"base_yield",110),o(k,"growth_time",720),o(k,"rot_time",1440),o(k,"water_consume_per_hour",16.67),o(k,"drought_penalty_per_hour",.05),o(k,"bug_penalty_per_hour",.03),o(k,"emoji","🌷");class T extends v{}o(T,"id","p04"),o(T,"name","Cà rốt"),o(T,"season",SEASON_SPRING),o(T,"buy_price",1500),o(T,"sell_price_per_yield",15),o(T,"base_yield",260),o(T,"growth_time",1440),o(T,"rot_time",1440),o(T,"water_consume_per_hour",16.67),o(T,"drought_penalty_per_hour",.05),o(T,"bug_penalty_per_hour",.03),o(T,"emoji","🥕");class A extends v{}o(A,"id","p05"),o(A,"name","Cà chua"),o(A,"season",SEASON_SUMMER),o(A,"buy_price",40),o(A,"sell_price_per_yield",6),o(A,"base_yield",10),o(A,"growth_time",15),o(A,"rot_time",1440),o(A,"water_consume_per_hour",16.67),o(A,"drought_penalty_per_hour",.05),o(A,"bug_penalty_per_hour",.03),o(A,"emoji","🍅");class I extends v{}o(I,"id","p06"),o(I,"name","Ớt chuông"),o(I,"season",SEASON_SUMMER),o(I,"buy_price",250),o(I,"sell_price_per_yield",10),o(I,"base_yield",45),o(I,"growth_time",360),o(I,"rot_time",1440),o(I,"water_consume_per_hour",16.67),o(I,"drought_penalty_per_hour",.05),o(I,"bug_penalty_per_hour",.03),o(I,"emoji","🫑");class E extends v{}o(E,"id","p07"),o(E,"name","Ngô"),o(E,"season",SEASON_SUMMER),o(E,"buy_price",700),o(E,"sell_price_per_yield",14),o(E,"base_yield",110),o(E,"growth_time",720),o(E,"rot_time",1440),o(E,"water_consume_per_hour",16.67),o(E,"drought_penalty_per_hour",.05),o(E,"bug_penalty_per_hour",.03),o(E,"emoji","🌽");class M extends v{}o(M,"id","p08"),o(M,"name","Dưa hấu"),o(M,"season",SEASON_SUMMER),o(M,"buy_price",1800),o(M,"sell_price_per_yield",18),o(M,"base_yield",260),o(M,"growth_time",1440),o(M,"rot_time",1440),o(M,"water_consume_per_hour",16.67),o(M,"drought_penalty_per_hour",.05),o(M,"bug_penalty_per_hour",.03),o(M,"emoji","🍉");class j extends v{}o(j,"id","p09"),o(j,"name","Cà tím"),o(j,"season",SEASON_AUTUMN),o(j,"buy_price",35),o(j,"sell_price_per_yield",5),o(j,"base_yield",10),o(j,"growth_time",15),o(j,"rot_time",1440),o(j,"water_consume_per_hour",16.67),o(j,"drought_penalty_per_hour",.05),o(j,"bug_penalty_per_hour",.03),o(j,"emoji","🍆");class L extends v{}o(L,"id","p10"),o(L,"name","Khoai lang"),o(L,"season",SEASON_AUTUMN),o(L,"buy_price",220),o(L,"sell_price_per_yield",9),o(L,"base_yield",44),o(L,"growth_time",360),o(L,"rot_time",1440),o(L,"water_consume_per_hour",16.67),o(L,"drought_penalty_per_hour",.05),o(L,"bug_penalty_per_hour",.03),o(L,"emoji","🍠");class D extends v{}o(D,"id","p11"),o(D,"name","Táo"),o(D,"season",SEASON_AUTUMN),o(D,"buy_price",650),o(D,"sell_price_per_yield",13),o(D,"base_yield",110),o(D,"growth_time",720),o(D,"rot_time",1440),o(D,"water_consume_per_hour",16.67),o(D,"drought_penalty_per_hour",.05),o(D,"bug_penalty_per_hour",.03),o(D,"emoji","🍎");class N extends v{}o(N,"id","p12"),o(N,"name","Bí ngô"),o(N,"season",SEASON_AUTUMN),o(N,"buy_price",2e3),o(N,"sell_price_per_yield",20),o(N,"base_yield",260),o(N,"growth_time",1440),o(N,"rot_time",1440),o(N,"water_consume_per_hour",16.67),o(N,"drought_penalty_per_hour",.05),o(N,"bug_penalty_per_hour",.03),o(N,"emoji","🎃");class C extends v{}o(C,"id","p13"),o(C,"name","Cải bắp"),o(C,"season",SEASON_WINTER),o(C,"buy_price",45),o(C,"sell_price_per_yield",6),o(C,"base_yield",11),o(C,"growth_time",15),o(C,"rot_time",1440),o(C,"water_consume_per_hour",16.67),o(C,"drought_penalty_per_hour",.05),o(C,"bug_penalty_per_hour",.03),o(C,"emoji","🥦");class B extends v{}o(B,"id","p14"),o(B,"name","Hành tây"),o(B,"season",SEASON_WINTER),o(B,"buy_price",260),o(B,"sell_price_per_yield",10),o(B,"base_yield",47),o(B,"growth_time",360),o(B,"rot_time",1440),o(B,"water_consume_per_hour",16.67),o(B,"drought_penalty_per_hour",.05),o(B,"bug_penalty_per_hour",.03),o(B,"emoji","🧅");class R extends v{}o(R,"id","p15"),o(R,"name","Củ cải"),o(R,"season",SEASON_WINTER),o(R,"buy_price",750),o(R,"sell_price_per_yield",15),o(R,"base_yield",110),o(R,"growth_time",720),o(R,"rot_time",1440),o(R,"water_consume_per_hour",16.67),o(R,"drought_penalty_per_hour",.05),o(R,"bug_penalty_per_hour",.03),o(R,"emoji","⬜");class P extends v{}o(P,"id","p16"),o(P,"name","Gừng"),o(P,"season",SEASON_WINTER),o(P,"buy_price",2200),o(P,"sell_price_per_yield",22),o(P,"base_yield",260),o(P,"growth_time",1440),o(P,"rot_time",1440),o(P,"water_consume_per_hour",16.67),o(P,"drought_penalty_per_hour",.05),o(P,"bug_penalty_per_hour",.03),o(P,"emoji","🫚");var At;let pt=(At=class{static register(t){this.classes[t.id]=t}static create(t,n={}){const s=this.classes[t];return s?new s(n):(console.warn(`Plant class for ID ${t} not found. Using BasePlant.`),new v(n))}},o(At,"classes",{}),At);[S,$,k,T,A,I,E,M,j,L,D,N,C,B,R,P].forEach(e=>pt.register(e));window.BasePlant=v;window.Plot=De;window.PlantFactory=pt;window.StrawberryPlant=S;window.CabbageGreenPlant=$;window.TulipPlant=k;window.CarrotPlant=T;window.TomatoPlant=A;window.BellPepperPlant=I;window.CornPlant=E;window.WatermelonPlant=M;window.EggplantPlant=j;window.SweetPotatoPlant=L;window.ApplePlant=D;window.PumpkinPlant=N;window.CabbageWinterPlant=C;window.OnionPlant=B;window.RadishPlant=R;window.GingerPlant=P;class rt{constructor(t,n,s,i,a,l){this.id=t,this.name=n,this.emoji=s,this.buyPrice=i,this.sellPrice=a,this.type=l}}class st extends rt{constructor(t,n,s,i,a){super(t,n,s,i,Math.floor(i*.5),"food"),this.energyRestored=a}}class yt extends rt{constructor(t,n,s,i,a,l){super(t,n,s,i,Math.floor(i*.5),"fertilizer"),this.multiplier=a,this.timeMultiplier=l}}class Ft extends rt{constructor(t=500){super("pesticide","Thuốc trừ sâu","🧪",t,Math.floor(t*.5),"pesticide")}}class Ht extends rt{constructor(t=50){super("medicine_animal","Thuốc thú y","💊",t,Math.floor(t*.5),"medicine_animal")}}var It;let q=(It=class{static register(t){this.items[t.id]=t}static get(t){return this.items[t]}static getAll(){return Object.values(this.items)}},o(It,"items",{}),It);q.register(new st("bread","Bánh mì","🍞",1e3,10));q.register(new st("noodle","Mì","🍜",1800,25));q.register(new st("rice","Cơm","🍚",4800,50));q.register(new st("poultry","Thức ăn gia cầm","🌾",50,0));q.register(new st("livestock","Thức ăn gia súc","🌾",50,0));q.register(new yt("1","Phân hữu cơ","💩",100,1.2,.9));q.register(new yt("2","Phân hóa học","🧪",250,1.5,.7));q.register(new yt("3","Phân thần kỳ","✨",600,2,.5));q.register(new Ft(500));q.register(new Ht(50));window.BaseShopItem=rt;window.FoodItem=st;window.FertilizerItem=yt;window.PesticideItem=Ft;window.MedicineAnimalItem=Ht;window.ShopItemRegistry=q;const Ot={0:{name:"Không có",multiplier:1,time_multiplier:1,price:0,emoji:""}};[1,2,3].forEach(e=>{const t=q.get(e.toString());t&&(Ot[e]={name:t.name,multiplier:t.multiplier,time_multiplier:t.timeMultiplier,price:t.buyPrice,emoji:t.emoji})});window.FERTILIZER_DATA=Ot;const Ne=q.get("pesticide").buyPrice;window.PESTICIDE_PRICE=Ne;const Kt={};for(const e in pt.classes){const t=pt.classes[e];Kt[e]={id:t.id,name:t.name,season:t.season,buy_price:t.buy_price,sell_price_per_yield:t.sell_price_per_yield,base_yield:t.base_yield,growth_time:t.growth_time,rot_time:t.rot_time,water_consume_per_hour:t.water_consume_per_hour,drought_penalty_per_hour:t.drought_penalty_per_hour,bug_penalty_per_hour:t.bug_penalty_per_hour,emoji:t.emoji}}window.PLANTS_DATA=Kt;class bt{constructor(t={}){this.id=t.id||"animal_"+Math.random().toString(36).substr(2,9),this.type=t.type||this.constructor.type,this.purchased_at=t.purchased_at||Date.now(),this.last_fed_at=t.last_fed_at||Date.now(),this.last_harvested_at=t.last_harvested_at||Date.now(),this.accumulated_production=typeof t.accumulated_production=="number"?t.accumulated_production:0,this.status=t.status||"baby",this.health=typeof t.health=="number"?t.health:100,this.dead_at=t.dead_at||null,this.last_calculated_at=t.last_calculated_at||this.purchased_at,this.sick_started_at=t.sick_started_at||null,this.medicine_until=t.medicine_until||null,this.grown_ms=typeof t.grown_ms=="number"?t.grown_ms:0}get name(){return this.constructor.name_label}get buy_price(){return this.constructor.buy_price}get sell_price(){return this.constructor.sell_price}get emoji(){return this.constructor.emoji}get production_rate(){return this.constructor.production_rate}get max_production(){return this.constructor.max_production}get feed_item(){return this.constructor.feed_item}get produce_item(){return this.constructor.produce_item}toJSON(){return{id:this.id,type:this.type,purchased_at:this.purchased_at,last_fed_at:this.last_fed_at,last_harvested_at:this.last_harvested_at,accumulated_production:this.accumulated_production,status:this.status,health:this.health,dead_at:this.dead_at,last_calculated_at:this.last_calculated_at,sick_started_at:this.sick_started_at,medicine_until:this.medicine_until,grown_ms:this.grown_ms}}lazyUpdate(t=Date.now()){if(this.status==="dead")return;const n=t-this.last_calculated_at;if(n<=0)return;const s=36e5,i=100/6,a=n/s;if(this.health>0){const c=this.health;if(this.health=Math.max(0,this.health-i*a),this.health<=0){const p=c/i;this.dead_at=this.last_calculated_at+p*s}}if(this.dead_at&&t-this.dead_at>=5*24*s){this.status="dead",this.health=0,this.last_calculated_at=t;return}if(!this.sick_started_at&&(!this.medicine_until||this.medicine_until<t)){let c=n;if(this.medicine_until&&this.medicine_until>this.last_calculated_at&&(c=t-this.medicine_until),c>0){const p=c/36e5,f=1-Math.pow(.95,p);if(Math.random()<f){const _=Math.random()*c;this.sick_started_at=Math.max(this.last_calculated_at,t-c)+_}}}const l=4*s;if(this.status==="baby"){let c=n;this.sick_started_at&&(this.sick_started_at>this.last_calculated_at&&this.sick_started_at<t?c=this.sick_started_at-this.last_calculated_at:c=0),this.grown_ms+=c,this.grown_ms>=l&&(this.status="adult")}if(this.status==="adult"&&(this.health>0||this.dead_at)){let c=a;if(this.dead_at){const f=this.dead_at-this.last_calculated_at;c=Math.max(0,f/s)}if(this.sick_started_at)if(this.sick_started_at>this.last_calculated_at&&this.sick_started_at<t){const f=this.sick_started_at-this.last_calculated_at;c=Math.min(c,Math.max(0,f/s))}else c=0;const p=c*this.production_rate;this.accumulated_production=Math.min(this.max_production,this.accumulated_production+p)}const d=t-this.purchased_at,u=14*24*s;d>=u&&(this.status="dead"),this.last_calculated_at=t}feed(t=Date.now()){return this.health>50?{ok:!1,msg:"Sinh lực vẫn trên 50%, chưa thể cho ăn!"}:(this.health=100,this.last_fed_at=t,this.dead_at=null,this.last_calculated_at=t,{ok:!0})}harvest(){if(this.status==="dead")return{ok:!1,msg:"Thú nuôi đã chết, không thể thu hoạch!"};if(this.status==="baby")return{ok:!1,msg:"Thú nuôi còn non, chưa thể sản xuất!"};const t=Math.floor(this.accumulated_production);return t<=0?{ok:!1,msg:"Chưa có sản phẩm tích lũy!"}:(this.accumulated_production=0,this.last_harvested_at=Date.now(),{ok:!0,qty:t})}}class H extends bt{}o(H,"type","chicken"),o(H,"name_label","Gà"),o(H,"buy_price",100),o(H,"sell_price",200),o(H,"emoji","🐔"),o(H,"production_rate",20),o(H,"max_production",20),o(H,"feed_item","food_poultry"),o(H,"produce_item","harvest_chicken_egg");class O extends bt{}o(O,"type","cow"),o(O,"name_label","Bò"),o(O,"buy_price",200),o(O,"sell_price",400),o(O,"emoji","🐮"),o(O,"production_rate",5),o(O,"max_production",5),o(O,"feed_item","food_livestock"),o(O,"produce_item","harvest_cow_milk");var Et;let Ge=(Et=class{static create(t,n={}){const s=this.classes[t];return s?new s(n):new bt(n)}},o(Et,"classes",{chicken:H,cow:O}),Et);window.BaseAnimal=bt;window.ChickenAnimal=H;window.CowAnimal=O;window.AnimalFactory=Ge;const Ce=24*60*60*1e3,Tt=24*60*60*1e3,Lt=[0];let Ut=12e3;for(let e=1;e<=36;e++)Lt.push(Ut),Ut*=2;function Mt(){const e=Date.now();return{gold:5e3,energy:100,season:"spring",game_day:1,lastDayTick:e,lastEnergyTick:e,needsStartSeason:!0,inventory:{},plots:Qt(),plots_unlocked:[3,0,0],plants:{},animals:[],poultry_capacity:3,livestock_capacity:3,lastAutoCheck:e,producerUnlocked:!1,producerSlots:[{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:e,timeSpent:0},{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:e,timeSpent:0},{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:e,timeSpent:0}]}}function Qt(){const e={};for(let t=0;t<3;t++)for(let n=0;n<36;n++)e[`${t}_${n}`]=new Plot({zone:t,index:n,locked:!0});return e}const Dt="mangak_farm_v1";function Vt(){try{const e=localStorage.getItem(Dt);let t;if(e?t=JSON.parse(e):(t=Mt(),t.needsStartSeason=!0),t.plots_unlocked||(t.plots_unlocked=[3,0,0]),t.inventory||(t.inventory={}),(typeof t.game_day!="number"||t.game_day<1)&&(t.game_day=1),t.lastDayTick||(t.lastDayTick=Date.now()),t.season||(t.season=Zt(t.game_day)),typeof t.needsStartSeason!="boolean"&&(t.needsStartSeason=!1),typeof t.energy!="number"&&(t.energy=100),typeof t.lastEnergyTick!="number"&&(t.lastEnergyTick=Date.now()),t.animals||(t.animals=[]),typeof t.poultry_capacity!="number"&&(t.poultry_capacity=3),typeof t.livestock_capacity!="number"&&(t.livestock_capacity=3),t.animals=t.animals.map(n=>AnimalFactory.create(n.type,n)),!t.quests||t.quests.length!==3?t.quests=[{quest:V(Z()),cooldownUntil:null},{quest:V(Z()),cooldownUntil:null},{quest:V(Z()),cooldownUntil:null}]:t.quests.forEach((n,s)=>{!n.cooldownUntil&&!n.quest&&(n.quest=V(Z()))}),typeof t.producerUnlocked>"u"&&(t.producerUnlocked=!1),(!t.producerSlots||t.producerSlots.length!==3)&&(t.producerSlots=[{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:Date.now(),timeSpent:0},{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:Date.now(),timeSpent:0},{inputKey:null,qtyLeft:0,qtyReady:0,lastUpdate:Date.now(),timeSpent:0}]),!t.plots||Object.keys(t.plots).length===0)t.plots=Qt();else{const n={};for(const s in t.plots){const i=s.split("_");i.length===2&&parseInt(i[1])<36&&(n[s]=new Plot(t.plots[s]))}for(let s=0;s<3;s++)for(let i=0;i<36;i++){const a=`${s}_${i}`;n[a]||(n[a]=new Plot({zone:s,index:i,locked:!0}))}t.plots=n}if(!t.plants)t.plants={};else{const n={};for(const s in t.plants){const i=s.split("_");i.length===2&&parseInt(i[1])<36&&t.plants[s]&&(n[s]=PlantFactory.create(t.plants[s].plant_id,t.plants[s]))}t.plants=n}return t}catch(e){console.error("Lỗi khi load game state, khôi phục lại mặc định:",e);const t=Mt();return t.needsStartSeason=!0,t}}function y(){localStorage.setItem(Dt,JSON.stringify(r))}function Zt(e){const t=Math.floor((e-1)/30)%SEASONS.length;return SEASONS[t]}function Yt(e){return(e-1)%30+1}function Be(){const t=Date.now()-r.lastDayTick;if(t<Tt)return!1;const n=Math.floor(t/Tt);r.game_day+=n,r.lastDayTick+=n*Tt;const s=Zt(r.game_day),i=s!==r.season;return r.season=s,y(),i}function Re(){localStorage.removeItem(Dt),r=Mt(),r.quests=[{quest:V(Z()),cooldownUntil:null},{quest:V(Z()),cooldownUntil:null},{quest:V(Z()),cooldownUntil:null}],lt(),y(),openStartSeasonModal()}function Pe(e){const t=SEASONS.indexOf(e);t!==-1&&(r.game_day=t*30+1,r.season=e,r.lastDayTick=Date.now(),r.needsStartSeason=!1,lt(),y(),render(),closeStartSeasonModal(),toast(`Bắt đầu từ ${SEASON_LABELS[e]} - ngày ${Yt(r.game_day)}/30`,"success"))}let r=Vt();function lt(){for(let e=0;e<3;e++){const t=r.plots_unlocked[e];for(let n=0;n<36;n++)r.plots[`${e}_${n}`].locked=n>=t}}lt();function it(e){return e&&e.lazyUpdate(Date.now())}function ze(e,t){return e?e.calcGrossYield():0}function Wt(e){return e?e.calcNetYield():0}function qe(){let e=!1;const t=Date.now();typeof r.lastEnergyTick!="number"&&(r.lastEnergyTick=t,e=!0);const n=t-r.lastEnergyTick,s=36e5;if(n>=s){const l=Math.floor(n/s);if(l>0){if(r.energy<100){const d=l*20;r.energy=Math.min(100,r.energy+d),e=!0}r.lastEnergyTick+=l*s}}for(const l in r.plants){const d=r.plants[l].status;r.plants[l]=r.plants[l].lazyUpdate(Date.now()),r.plants[l].status!==d&&(e=!0)}return r.animals&&r.animals.length>0&&r.animals.forEach(l=>{const d=l.status;l.lazyUpdate(t),l.status!==d&&(e=!0)}),Jt()&&(e=!0),Xt(t)&&(e=!0),e&&y(),e}function K(e=1){return typeof r.energy!="number"&&(r.energy=100),r.energy<e?{ok:!1,msg:"❌ Không đủ năng lượng! Hãy ăn thêm thức ăn hoặc nông sản."}:(r.energy-=e,{ok:!0})}function Ue(e,t,n=0){const s=r.plots[e];if(!s||s.locked)return{ok:!1,msg:"Ô đất bị khóa"};if(r.plants[e])return{ok:!1,msg:"Ô đất đã có cây"};const i=PLANTS_DATA[t];if(!i)return{ok:!1,msg:"Không tìm thấy cây"};if(!r.inventory[t]||r.inventory[t]<=0)return{ok:!1,msg:"Không có hạt giống trong túi"};const a=K(1);if(!a.ok)return a;r.inventory[t]--;const l=Date.now(),d=i.season!==r.season;return r.plants[e]=PlantFactory.create(t,{plot_key:e,plant_id:t,status:0,planted_at:l,is_wrong_season:d,fertilizer_type:0,current_water:0,last_watered_at:null,bug_started_at:null,pesticide_until:null,lost_yield_by_water:0,lost_yield_by_bug:0,last_calculated_at:l,grown_ms:0,rot_ms:0}),y(),{ok:!0}}function Fe(e){const t=r.plants[e];if(!t)return{ok:!1,msg:"Không có cây"};if(t.status===2)return{ok:!1,msg:"Cây đã chết"};if(t.current_water>50)return{ok:!1,msg:"Nước vẫn còn đủ (>50%)"};const n=K(1);return n.ok?(r.plants[e]=it(t),r.plants[e].current_water=100,r.plants[e].last_watered_at=Date.now(),y(),{ok:!0}):n}function He(e){const t=r.plants[e];if(!t)return{ok:!1,msg:"Không có cây"};if(!t.bug_started_at)return{ok:!1,msg:"Không có sâu"};const n=K(1);return n.ok?(r.plants[e]=it(t),r.plants[e].bug_started_at=null,y(),{ok:!0}):n}function Oe(e){const t=r.plants[e];if(!t)return{ok:!1,msg:"Không có cây"};if(!r.inventory.pesticide||r.inventory.pesticide<=0)return{ok:!1,msg:"Không có thuốc trừ sâu"};const n=K(1);return n.ok?(r.plants[e]=it(t),r.plants[e].bug_started_at=null,r.plants[e].pesticide_until=Date.now()+Ce,r.inventory.pesticide--,r.inventory.pesticide<=0&&delete r.inventory.pesticide,y(),{ok:!0}):n}function Ke(e,t){const n=r.plants[e];if(!n)return{ok:!1,msg:"Không có cây"};if(n.status===2)return{ok:!1,msg:"Cây đã chết"};if(!Number.isInteger(t)||t<=0)return{ok:!1,msg:"Loại phân không hợp lệ"};const s=`fertilizer_${t}`;if(!r.inventory[s]||r.inventory[s]<=0)return{ok:!1,msg:"Không có phân bón trong túi"};const i=K(1);return i.ok?(r.plants[e]=it(n),r.plants[e].fertilizer_type=t,r.inventory[s]--,r.inventory[s]<=0&&delete r.inventory[s],y(),{ok:!0}):i}function Qe(e){const t=r.plants[e];if(!t)return{ok:!1,msg:"Không có cây"};r.plants[e]=it(t);const n=r.plants[e];if(n.status===0)return{ok:!1,msg:"Cây chưa chín"};if(n.status===2)return{ok:!1,msg:"Cây đã chết, phải cuốc hoặc dọn cây chết!"};const s=K(1);if(!s.ok)return s;const i=PLANTS_DATA[n.plant_id],a=Wt(n),l=`harvest_${n.plant_id}`;return r.inventory[l]=(r.inventory[l]||0)+a,delete r.plants[e],y(),{ok:!0,qty:a,plant:i}}function Ve(e){const t=r.plants[e];if(!t||t.status!==2)return{ok:!1,msg:"Không phải cây chết"};const n=K(1);return n.ok?(delete r.plants[e],y(),{ok:!0}):n}function Ze(e){if(!r.plants[e])return{ok:!1,msg:"Không có cây ở ô này"};const n=K(1);return n.ok?(delete r.plants[e],y(),{ok:!0}):n}function Ye(e,t,n=1){let s=0,i="";if(e==="animal")if(t==="chicken"){const a=r.animals.filter(l=>l.type==="chicken").length;if(a+n>r.poultry_capacity)return{ok:!1,msg:`Chuồng gà không đủ chỗ trống (Còn: ${r.poultry_capacity-a})`};s=100*n}else if(t==="cow"){const a=r.animals.filter(l=>l.type==="cow").length;if(a+n>r.livestock_capacity)return{ok:!1,msg:`Chuồng bò không đủ chỗ trống (Còn: ${r.livestock_capacity-a})`};s=200*n}else return{ok:!1,msg:"Không tìm thấy loại vật nuôi này"};else if(e==="seed"){const a=PLANTS_DATA[t];if(!a)return{ok:!1,msg:"Không tìm thấy cây"};s=a.buy_price*n,i=t}else if(e==="fertilizer"){const a=ShopItemRegistry.get(t);if(!a)return{ok:!1,msg:"Không tìm thấy loại phân bón này"};s=a.buyPrice*n,i=`fertilizer_${t}`}else if(e==="pesticide")s=ShopItemRegistry.get("pesticide").buyPrice*n,i="pesticide";else if(e==="food"){const a=ShopItemRegistry.get(t);if(!a)return{ok:!1,msg:"Không tìm thấy loại thực phẩm này"};s=a.buyPrice*n,i=`food_${t}`}else if(e==="medicine_animal"){const a=ShopItemRegistry.get("medicine_animal");if(!a)return{ok:!1,msg:"Không tìm thấy thuốc thú y"};s=a.buyPrice*n,i="medicine_animal"}if(r.gold<s)return{ok:!1,msg:`Không đủ vàng (cần ${s}🪙)`};if(r.gold-=s,e==="animal")for(let a=0;a<n;a++)r.animals.push(AnimalFactory.create(t,{purchased_at:Date.now()}));else r.inventory[i]=(r.inventory[i]||0)+n;return y(),{ok:!0,cost:s}}function We(e,t=1){if(!r.inventory[e]||r.inventory[e]<t)return{ok:!1,msg:"Không đủ hàng để bán"};let n=0;if(e==="cheese")n=2500*t;else if(e==="harvest_chicken_egg")n=50*t;else if(e==="harvest_cow_milk")n=500*t;else if(e.startsWith("harvest_")){const s=e.replace("harvest_",""),i=PLANTS_DATA[s];if(!i)return{ok:!1,msg:"Không xác định được loại nông sản"};n=i.sell_price_per_yield*t}else if(e.startsWith("fertilizer_")){const s=e.replace("fertilizer_",""),i=ShopItemRegistry.get(s);n=Math.floor(((i==null?void 0:i.buyPrice)||0)*.5*t)}else if(e==="pesticide"){const s=ShopItemRegistry.get("pesticide");n=Math.floor(((s==null?void 0:s.buyPrice)||500)*.5*t)}else if(e==="medicine_animal"){const s=ShopItemRegistry.get("medicine_animal");n=Math.floor(((s==null?void 0:s.buyPrice)||50)*.5*t)}else if(e.startsWith("food_")){const s=e.replace("food_",""),i=ShopItemRegistry.get(s);n=Math.floor(((i==null?void 0:i.buyPrice)||0)*.5*t)}else{const s=PLANTS_DATA[e];s&&(n=Math.floor(s.buy_price*.5*t))}return r.inventory[e]-=t,r.inventory[e]<=0&&delete r.inventory[e],r.gold+=n,y(),{ok:!0,revenue:n}}function Je(e,t=1){return!r.inventory[e]||r.inventory[e]<t?{ok:!1,msg:"Không đủ vật phẩm trong túi!"}:(r.inventory[e]-=t,r.inventory[e]<=0&&delete r.inventory[e],y(),{ok:!0})}function Xe(e){if(e>0&&r.plots_unlocked[e-1]<36)return{ok:!1,msg:`Phải mở khóa hết Khu ${e} trước!`};const t=r.plots_unlocked[e],n=r.plots_unlocked.reduce((a,l)=>a+l,0),s=Math.floor(n/3),i=Lt[s]??999999;return t>=36?{ok:!1,msg:"Khu đất đã đầy"}:r.gold<i?{ok:!1,msg:`Cần ${i}🪙`}:(r.gold-=i,r.plots_unlocked[e]=Math.min(36,t+3),lt(),y(),{ok:!0,price:i})}function tn(e){if(e==="poultry"){const t=r.poultry_capacity;if(t>=20)return{ok:!1,msg:"Chuồng gà đã đạt sức chứa tối đa (20)"};const n=12e3*Math.pow(2,t-3);return r.gold<n?{ok:!1,msg:`Cần ${n}🪙 để mở rộng!`}:(r.gold-=n,r.poultry_capacity+=1,y(),{ok:!0,price:n,newCap:r.poultry_capacity})}else if(e==="livestock"){const t=r.livestock_capacity;if(t>=20)return{ok:!1,msg:"Chuồng bò đã đạt sức chứa tối đa (20)"};const n=12e3*Math.pow(2,t-3);return r.gold<n?{ok:!1,msg:`Cần ${n}🪙 để mở rộng!`}:(r.gold-=n,r.livestock_capacity+=1,y(),{ok:!0,price:n,newCap:r.livestock_capacity})}return{ok:!1,msg:"Loại chuồng không hợp lệ"}}function en(e){const t=r.animals.find(a=>a.id===e);if(!t)return{ok:!1,msg:"Không tìm thấy con vật!"};const n=t.feed_item;if(!r.inventory[n]||r.inventory[n]<1)return{ok:!1,msg:`Không đủ thức ăn trong túi (cần 1 ${n==="food_poultry"?"thức ăn gia cầm":"thức ăn gia súc"})!`};const s=K(1);if(!s.ok)return s;t.lazyUpdate(Date.now());const i=t.feed(Date.now());return i.ok?(r.inventory[n]-=1,r.inventory[n]<=0&&delete r.inventory[n],y(),{ok:!0}):i}function nn(e){return e.lazyUpdate(Date.now()),e.health<=50}function sn(e){const t=r.animals.find(a=>a.id===e);if(!t)return{ok:!1,msg:"Không tìm thấy con vật!"};const n=K(1);if(!n.ok)return n;t.lazyUpdate(Date.now());const s=t.harvest();if(!s.ok)return s;const i=t.produce_item;return r.inventory[i]=(r.inventory[i]||0)+s.qty,y(),{ok:!0,qty:s.qty,item:i}}function on(e){const t=r.animals.findIndex(i=>i.id===e);if(t===-1)return{ok:!1,msg:"Không tìm thấy con vật!"};const n=r.animals[t];if(n.lazyUpdate(Date.now()),n.status!=="adult")return{ok:!1,msg:"Con vật chưa trưởng thành, không thể bán!"};const s=n.sell_price;return r.gold+=s,r.animals.splice(t,1),y(),{ok:!0,price:s}}function an(e){const t=r.animals.findIndex(s=>s.id===e);return t===-1?{ok:!1,msg:"Không tìm thấy con vật!"}:r.animals[t].status!=="dead"?{ok:!1,msg:"Con vật vẫn còn sống!"}:(r.animals.splice(t,1),y(),{ok:!0})}function rn(e){const t=r.animals.find(i=>i.id===e);if(!t)return{ok:!1,msg:"Không tìm thấy vật nuôi!"};if(t.status==="dead")return{ok:!1,msg:"Vật nuôi đã chết!"};const n="medicine_animal";if(!r.inventory[n]||r.inventory[n]<1)return{ok:!1,msg:"Không đủ Thuốc thú y trong túi (cần 1)!"};const s=K(1);return s.ok?(t.lazyUpdate(Date.now()),t.sick_started_at=null,t.medicine_until=Date.now()+24*60*60*1e3,r.inventory[n]--,r.inventory[n]<=0&&delete r.inventory[n],y(),{ok:!0}):s}function ln(e){r.season=e,y()}function cn(){const e=[];for(const t in PLANTS_DATA)e.push({key:`harvest_${t}`,name:PLANTS_DATA[t].name,emoji:PLANTS_DATA[t].emoji,sellPrice:PLANTS_DATA[t].sell_price_per_yield});return e.push({key:"harvest_chicken_egg",name:"Trứng gà",emoji:"🥚",sellPrice:50}),e.push({key:"harvest_cow_milk",name:"Sữa bò",emoji:"🥛",sellPrice:500}),e.push({key:"cheese",name:"Phô mai",emoji:"🧀",sellPrice:800}),e}function dn(e,t){return t>=500?Math.floor(Math.random()*3)+1:t>=50?Math.floor(Math.random()*7)+2:t>=18?Math.floor(Math.random()*5)+2:t>=12?Math.floor(Math.random()*8)+3:t>=8?Math.floor(Math.random()*9)+4:Math.floor(Math.random()*11)+5}function Z(){return Math.floor(Math.random()*3)+1}function V(e){const t=cn();let n=1,s=1.5;e===2?(n=3,s=2):e===3&&(n=5,s=2.5);const l=[...t].sort(()=>.5-Math.random()).slice(0,n).map(c=>{const p=dn(c.key,c.sellPrice);return{key:c.key,name:c.name,emoji:c.emoji,qtyRequired:p,sellPrice:c.sellPrice}});let d=0;l.forEach(c=>{d+=c.qtyRequired*c.sellPrice});const u=Math.round(d*s);return{id:"quest_"+Math.random().toString(36).substr(2,9),level:e,items:l,rewardGold:u,baseValue:d,completed:!1}}function un(e){const t=r.quests[e];if(!t||!t.quest||t.quest.completed)return{ok:!1,msg:"Nhiệm vụ không hợp lệ hoặc đã hoàn thành!"};const n=t.quest;for(const s of n.items){const i=r.inventory[s.key]||0;if(i<s.qtyRequired)return{ok:!1,msg:`Thiếu vật phẩm: ${s.emoji} ${s.name} (Cần: ${s.qtyRequired}, Có: ${i})`}}for(const s of n.items)r.inventory[s.key]-=s.qtyRequired,r.inventory[s.key]<=0&&delete r.inventory[s.key];return r.gold+=n.rewardGold,t.quest=V(Z()),t.cooldownUntil=null,y(),{ok:!0,rewardGold:n.rewardGold}}function pn(e){const t=r.quests[e];if(!t||t.cooldownUntil)return{ok:!1,msg:"Đang trong thời gian chờ hoặc slot không hợp lệ!"};const n=Date.now();return t.cooldownUntil=n+15*60*1e3,t.quest=null,y(),{ok:!0}}function Jt(){let e=!1;const t=Date.now();return r.quests&&r.quests.length>0&&r.quests.forEach((n,s)=>{n.cooldownUntil&&t>=n.cooldownUntil&&(n.quest=V(Z()),n.cooldownUntil=null,e=!0)}),e&&y(),e}function _t(e){if(!e)return null;if(e==="harvest_cow_milk")return{key:"cheese",name:"Phô mai",emoji:"🧀",time:5*60*1e3,inputRatio:4};if(e.startsWith("harvest_")){const t=e.replace("harvest_",""),n=PLANTS_DATA[t];if(n)return{key:t,name:n.name+" (Hạt)",emoji:n.emoji,time:5*60*1e3,inputRatio:1}}return null}function hn(){return r.producerUnlocked?{ok:!1,msg:"Nhà sản xuất vật tư đã được mở khoá từ trước!"}:r.gold<1e5?{ok:!1,msg:"Không đủ vàng để mở khoá (Cần 100.000 🪙)!"}:(r.gold-=1e5,r.producerUnlocked=!0,y(),{ok:!0})}function fn(e,t,n){if(!r.producerUnlocked)return{ok:!1,msg:"Nhà sản xuất vật tư chưa được mở khoá!"};const s=r.producerSlots[e];if(!s)return{ok:!1,msg:"Slot không hợp lệ!"};if(s.inputKey&&s.inputKey!==t)return{ok:!1,msg:"Slot đang sản xuất vật phẩm khác, không thể trộn lẫn!"};const i=_t(t),a=i&&i.inputRatio||1;if(t==="harvest_cow_milk"&&n%a!==0)return{ok:!1,msg:`Số lượng sữa bò nạp vào phải là bội số của ${a}!`};const l=s.qtyLeft+s.qtyReady*a;return l+n>64?{ok:!1,msg:`Vượt quá giới hạn chứa tối đa 64 nguyên liệu trong một slot (Hiện có tương đương: ${l})!`}:(r.inventory[t]||0)<n?{ok:!1,msg:"Không đủ vật phẩm trong túi đồ!"}:(r.inventory[t]-=n,r.inventory[t]<=0&&delete r.inventory[t],s.inputKey=t,s.qtyLeft+=n,s.qtyLeft===n&&(s.lastUpdate=Date.now(),s.timeSpent=0),y(),{ok:!0})}function mn(e){if(!r.producerUnlocked)return{ok:!1,msg:"Nhà sản xuất vật tư chưa được mở khoá!"};const t=r.producerSlots[e];if(!t||t.qtyReady<=0)return{ok:!1,msg:"Không có vật phẩm nào đã hoàn thành để thu hoạch!"};const n=_t(t.inputKey);if(!n)return{ok:!1,msg:"Vật phẩm không hợp lệ!"};const s=t.qtyReady;return r.inventory[n.key]=(r.inventory[n.key]||0)+s,t.qtyReady=0,t.qtyLeft===0&&(t.inputKey=null,t.timeSpent=0),y(),{ok:!0,key:n.key,name:n.name,emoji:n.emoji,qty:s}}function Xt(e=Date.now()){let t=!1;return!r.producerUnlocked||!r.producerSlots?!1:(r.producerSlots.forEach(n=>{if(n.inputKey&&n.qtyLeft>0){n.lastUpdate||(n.lastUpdate=e);const s=e-n.lastUpdate;n.timeSpent+=s,n.lastUpdate=e;const i=_t(n.inputKey),a=i?i.time:5*60*1e3,l=i&&i.inputRatio||1;if(n.timeSpent>=a){const d=Math.floor(n.timeSpent/a),u=Math.floor(n.qtyLeft/l),c=Math.min(d,u);c>0&&(n.qtyReady+=c,n.qtyLeft-=c*l,n.timeSpent=n.timeSpent%a,n.qtyLeft<l&&(n.timeSpent=0),t=!0)}}else n.inputKey&&n.qtyLeft===0&&(n.lastUpdate=e)}),t)}window.GAME={G:r,PLANTS_DATA,FERTILIZER_DATA,SEASONS,SEASON_LABELS,PESTICIDE_PRICE,LAND_PRICES:Lt,loadState:Vt,saveState:y,syncUnlockedPlots:lt,lazyUpdateAll:qe,lazyUpdatePlant:it,calcNetYield:Wt,calcGrossYield:ze,plantSeed:Ue,waterPlant:Fe,catchBug:He,usePesticide:Oe,useFertilizer:Ke,harvestPlant:Qe,removeDead:Ve,clearPlot:Ze,buyItem:Ye,sellItem:We,buyLand:Xe,changeSeason:ln,expandBarn:tn,feedAnimal:en,harvestAnimal:sn,sellAnimal:on,removeDeadAnimal:an,canFeedAnimal:nn,cureAnimal:rn,discardItem:Je,completeQuest:un,resetQuest:pn,checkQuestCooldowns:Jt,generateRandomQuest:V,unlockProducer:hn,loadProducerSlot:fn,collectProducerSlot:mn,updateProducer:Xt,getProducerOutputInfo:_t,updateSeasonClock:Be,getDayOfSeason:Yt,resetGame:Re,setStartSeason:Pe};for(const e in window.GAME)window[e]=window.GAME[e];function te(){let e='<div class="space-y-6">';for(let t=0;t<3;t++){const n=G.plots_unlocked[t],s=t>0?G.plots_unlocked[t-1]:36,i=t>0&&s<36;if(e+=`
    ...
    `,[{rStart:0,rEnd:3,cStart:0,cEnd:3},{rStart:0,rEnd:3,cStart:3,cEnd:6},{rStart:3,rEnd:6,cStart:0,cEnd:3},{rStart:3,rEnd:6,cStart:3,cEnd:6}].forEach(c=>{e+='<div class="grid grid-cols-3 gap-1">';for(let p=c.rStart;p<c.rEnd;p++)for(let f=c.cStart;f<c.cEnd;f++){const _=p*6+f,m=`${t}_${_}`,b=G.plots[m],g=G.plants[m],w=selectedPlot===m,Q="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14";if(!b||b.locked){e+=`
              <div class="plot-cell locked select-none flex items-center justify-center border border-gray-700/60 rounded-lg bg-gray-950/80 text-lg cursor-not-allowed ${Q}" title="Ô đất bị khóa">
                🔒
              </div>
            `;continue}if(!g){e+=`
              <div class="plot-cell empty select-none flex items-center justify-center border border-gray-700 rounded-lg bg-amber-950/40 text-2xl cursor-pointer hover:border-yellow-400 transition-all ${w?"ring-2 ring-yellow-400 border-yellow-400":""} ${Q}"
                data-plot-key="${m}" title="Ô trống - click để trồng cây" onclick="selectPlotCell('${m}')">
                🟫
              </div>
            `;continue}const U=PLANTS_DATA[g.plant_id],$t=Math.round(g.current_water),X=!!g.bug_started_at,ut=g.status===0?"growing":g.status===1?"ready":"dead",z=X?"bug":"",kt=g.status===0?"🌱":g.status===1?U.emoji:"💀",at=g.status===1?"✨":"";e+=`
            <div class="plot-cell ${ut} ${z} select-none flex flex-col justify-between p-1 border border-gray-700 rounded-lg bg-amber-950/40 cursor-pointer relative hover:border-yellow-400 transition-all ${w?"ring-2 ring-yellow-400 border-yellow-400":""} ${Q}"
              data-plot-key="${m}" title="${U.name}" onclick="selectPlotCell('${m}')">
    ...
    `}return e+="</div>",e}window.renderCropsView=te;function ot(){var b,g,w;const e=document.getElementById("plotModalContent"),t=document.getElementById("plotModalTitle");if(!selectedPlot||!e||!t)return;wt();const n=G.plots[selectedPlot];if(!n||n.locked)return;const s=G.plants[selectedPlot];if(!s){t.textContent="🟫 Ô đất trống",e.innerHTML=`
    ...
    `;return}const i=PLANTS_DATA[s.plant_id],a=Math.round(s.current_water),l=calcGrossYield(s,i),d=calcNetYield(s),u=s.status===0?'<span class="text-green-400 font-bold">🌱 Sinh trưởng</span>':s.status===1?'<span class="text-yellow-400 font-bold">✨ Sẵn sàng thu hoạch</span>':'<span class="text-red-400 font-bold">💀 Đã chết</span>',c=s.is_wrong_season?'<span class="text-red-400 text-xs">(⚠️ trái mùa -50%)</span>':"",p=Date.now(),f=i.growth_time*6e4*(((b=FERTILIZER_DATA[s.fertilizer_type])==null?void 0:b.time_multiplier)||1);let _="";if(s.status===0){const Q=Math.max(0,f-(s.grown_ms||0));_=`⏱️ Còn ${F(Q)}`,s.current_water<=0&&(_+=' <span class="text-red-400 text-[10px] ml-1">(Tạm dừng do thiếu nước)</span>')}else if(s.status===1){const Q=i.rot_time*6e4,U=Math.max(0,Q-(s.rot_ms||0));_=`<span class="text-yellow-400">⚠️ Héo sau ${F(U)}</span>`}t.textContent="📋 Chi tiết ô đất";let m="";s.status===2?m=`
  ...
  `}window.renderPlotModalContent=ot;function ee(){const e=Object.values(G.plants),t=e.filter(l=>l.status===0).length,n=e.filter(l=>l.status===1).length,s=e.filter(l=>l.status===2).length,i=e.filter(l=>l.bug_started_at).length,a=document.getElementById("farmSummary");a&&(a.innerHTML=`
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4" id="seedPicker" style="max-height: 45vh; overflow-y: auto;">
      ${n.map(i=>{const a=PLANTS_DATA[i],l=a.season!==G.season,d=a.growth_time*6e4,u=a.base_yield;return`<div class="plant-card ${l?"wrong-season":""} ${selectedPlantId===i?"selected":""}" id="seed_${i}" data-action="select-seed" data-seed-id="${i}">
  ...
  `}window.renderFertilizerViewContent=Gt;function re(e){selectedFertilizerType=e,Gt()}window.selectFertilizerType=re;function le(){if(!selectedFertilizerType){h("Chọn loại phân trước!","error");return}const e=useFertilizer(fertilizePlotKey,selectedFertilizerType);if(!e.ok){h(e.msg,"error");return}h(`🌿 Đã bón ${FERTILIZER_DATA[selectedFertilizerType].name}!`,"success"),x(),xt()}window.confirmFertilizer=le;function xt(){currentModalScreen="details",ot()}window.goBackToDetails=xt;function ce(e){const t=G.plots[e];if(!t||t.locked){h("🔒 Ô đất này bị khóa!","error");return}selectedPlot=e,currentModalScreen="details",x();const n=document.getElementById("plotModal");n&&(n.style.display="flex"),ot()}window.selectPlot=ce;function de(e){const t=waterPlant(e);if(!t.ok){h(t.msg,"error");return}x(),h("💧 Đã tưới nước!","success")}window.handleWater=de;function ue(e){const t=catchBug(e);if(!t.ok){h(t.msg,"error");return}x(),h("👋 Đã bắt sâu!","success")}window.handleCatchBug=ue;function pe(e){const t=usePesticide(e);if(!t.ok){h(t.msg,"error");return}x(),h("🧪 Đã phun thuốc! (hiệu lực 24h)","success")}window.handlePesticide=pe;function he(e){const t=harvestPlant(e);t.ok?(tt(),x(),h(`🌾 Thu hoạch ${t.qty} ${t.plant.name}! (+${t.qty*t.plant.sell_price_per_yield}🪙 nếu bán)`,"success")):(x(),h(t.msg,"error"))}window.handleHarvest=he;function fe(e){const t=G.plants[e];if(!t)return;const n=PLANTS_DATA[t.plant_id];if(!confirm(`Bạn có chắc chắn muốn dọn cây chết ${n.name} không? (Tốn 1 ⚡)`))return;const s=removeDead(e);s&&s.ok?(tt(),x(),h("🗑️ Đã dọn cây chết","info")):s&&h(s.msg,"error")}window.handleRemoveDead=fe;function me(e){const t=G.plants[e];if(!t)return;const n=PLANTS_DATA[t.plant_id];if(confirm(`Bạn có chắc chắn muốn cuốc đất để huỷ bỏ cây ${n.name} không? (Hạt giống sẽ không được hoàn lại)`)){const s=clearPlot(e);s.ok?(tt(),x(),h("⛏️ Đã cuốc đất và huỷ cây thành công!","success")):h(s.msg,"error")}}window.handleClearPlot=me;function gn(){const e=buyLand(currentZone);if(!e.ok){h(e.msg,"error");return}x(),h(`🏗️ Đã mở thêm 3 ô đất! (-${e.price}🪙)`,"success")}window.handleBuyLand=gn;function Ct(e){const t=e.split("_"),n=t[0]!==void 0?parseInt(t[0]):0,s=t[1]!==void 0?parseInt(t[1]):0,i=n*36+s;let a=null,l=!1;if(i>0){const c=Math.floor((i-1)/36),p=(i-1)%36;a=`${c}_${p}`;const f=G.plots[a];f&&!f.locked&&(l=!0)}let d=null,u=!1;if(i<107){const c=Math.floor((i+1)/36),p=(i+1)%36;d=`${c}_${p}`;const f=G.plots[d];f&&!f.locked&&(u=!0)}return{prevKey:a,prevActive:l,nextKey:d,nextActive:u}}window.getNavigationPlots=Ct;function wt(){const e=document.getElementById("btnPrevPlot"),t=document.getElementById("btnNextPlot");if(!e||!t||!selectedPlot)return;const n=Ct(selectedPlot);e.disabled=!n.prevActive,t.disabled=!n.nextActive}window.updatePlotNavigationButtons=wt;function yn(e){if(!selectedPlot)return;const t=Ct(selectedPlot),n=e==="prev"?t.prevKey:t.nextKey;(e==="prev"?t.prevActive:t.nextActive)&&n&&(selectedPlot=n,ot(),renderFarmGridArea())}window.navigatePlot=yn;document.addEventListener("click",e=>{const t=e.target;if(t.closest(".close-plot-modal")||t.closest('[data-action="close-plot-modal"]')){tt(),e.preventDefault();return}const n=t.closest(".plot-cell");if(n&&n.hasAttribute("data-plot-key")){const i=n.getAttribute("data-plot-key");ce(i),e.preventDefault();return}const s=t.closest("[data-action]");if(s){const i=s.getAttribute("data-action"),a=s.getAttribute("data-plot")||selectedPlot;switch(i){case"close-plot-modal":tt();break;case"open-planting-view":ne();break;case"water-plant":de(a);break;case"open-fertilizer-view":ae();break;case"harvest-plant":he(a);break;case"catch-bug":ue(a);break;case"pesticide-plant":pe(a);break;case"clear-plot":me(a);break;case"remove-dead":fe(a);break;case"go-back-to-details":xt();break;case"close-plot-modal-open-shop":tt(),$e("viewShop");break;case"select-seed":const l=s.getAttribute("data-seed-id");se(l);break;case"select-fert":const d=parseInt(s.getAttribute("data-fert-id"));ie(d);break;case"confirm-plant":oe();break;case"select-fertilizer-type":const u=parseInt(s.getAttribute("data-fertilizer-type"));re(u);break;case"confirm-fertilizer":le();break}e.preventDefault()}});function jt(e){const t=e==="poultry",n=t?"Chuồng gia cầm 🐔":"Chuồng gia súc 🐮",s=t?G.poultry_capacity:G.livestock_capacity,i=G.animals.filter(c=>c.type===(t?"chicken":"cow")),a=12e3*Math.pow(2,s-3),l=t?"food_poultry":"food_livestock",d=G.inventory[l]||0;let u=`
  ...
  `,i.length===0?u+=`
    ...
    `:(u+='<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">',i.forEach(c=>{c.lazyUpdate(Date.now());const p=Date.now(),f=p-c.purchased_at,_=4,m=36e5;let b="",g="",w="",Q="";if(c.status!=="dead"&&c.medicine_until&&c.medicine_until>p&&(Q=`<div class="text-[11px] text-cyan-400 font-bold flex items-center gap-1 mt-0.5">🛡️ Kháng bệnh: ${F(c.medicine_until-p)}</div>`),c.status==="dead")b="Đã chết 💀",g="text-red-400",w="Sinh vật đã qua đời";else if(c.sick_started_at)if(b="Nhiễm bệnh 🤒",g="text-purple-400 font-extrabold animate-pulse",c.status==="baby"){const z=Math.max(0,_*m-c.grown_ms);w=`Trưởng thành sau: <span class="text-white font-bold font-mono">${F(z)}</span> <span class="text-purple-400 font-semibold block text-[10px] mt-0.5">⚠️ Đã dừng lớn do bệnh</span>`}else{const z=Math.max(0,336*m-f);w=`Tuổi thọ còn: <span class="text-white font-bold font-mono">${F(z)}</span> <span class="text-purple-400 font-semibold block text-[10px] mt-0.5">⚠️ Đã dừng sản xuất do bệnh</span>`}else if(c.status==="baby"){b="Con non 🍼",g="text-green-400";const z=Math.max(0,_*m-c.grown_ms);w=`Trưởng thành sau: <span class="text-white font-bold font-mono">${F(z)}</span>`}else{b="Trưởng thành ✨",g="text-yellow-400";const z=Math.max(0,14*24*m-f);w=`Tuổi thọ còn: <span class="text-white font-bold font-mono">${F(z)}</span>`}const U=Math.round(c.health),$t=U<=20?"bg-red-500":U<=50?"bg-yellow-500":"bg-green-500",X=Math.floor(c.accumulated_production),ut=c.max_production;if(u+=`
            ...
            <div class="space-y-1.5 text-xs text-gray-300">
              ...
              <div>
                <div class="flex justify-between mb-0.5 font-semibold text-[11px]">
                  <span>Sinh lực:</span>
                  <span class="${U<=20?"text-red-400":U<=50?"text-yellow-400":"text-green-400"} font-bold font-mono">${U}%</span>
                </div>
                <div class="w-full bg-gray-900 rounded-full h-2 overflow-hidden shadow-inner border border-gray-700">
                  <div class="${$t} h-2 rounded-full transition-all" style="width: ${U}%"></div>
                </div>
              </div>
      ...
      `,c.status==="dead")u+=`
        ...
        `;else{u+='<div class="grid grid-cols-2 gap-2">';const z=U<=50;if(u+=`
  ...
  `,u}window.renderBarnView=jt;function bn(e){const t=GAME.expandBarn(e);t.ok?(x(),h(`🏗️ Mở rộng chuồng thành công! Sức chứa mới: ${t.newCap} con`,"success")):h(t.msg,"error")}window.handleExpandBarn=bn;function _n(e){const t=GAME.feedAnimal(e);t.ok?(x(),h("🥣 Cho vật nuôi ăn thành công! Sinh lực hồi phục 100%","success")):h(t.msg,"error")}window.handleFeedAnimal=_n;function xn(e){const t=GAME.harvestAnimal(e);if(t.ok){x();const n=t.item==="harvest_chicken_egg"?"Trứng gà":"Sữa bò";h(`🧺 Đã thu hoạch ${t.qty} ${n}! (+${t.item==="harvest_chicken_egg"?t.qty*50:t.qty*500}🪙 nếu bán)`,"success")}else h(t.msg,"error")}window.handleHarvestAnimal=xn;function wn(e){const t=G.animals.find(i=>i.id===e);if(!t){h("Không tìm thấy vật nuôi!","error");return}const n=t.type==="chicken"?"Gà":t.type==="cow"?"Bò":t.type;if(!confirm(`Bạn có chắc chắn muốn bán con ${n} này với giá ${t.sell_price}🪙 không?`))return;const s=GAME.sellAnimal(e);s.ok?(x(),h(`💰 Đã bán vật nuôi! Nhận được +${s.price}🪙`,"success")):h(s.msg,"error")}window.handleSellAnimal=wn;function vn(e){const t=GAME.removeDeadAnimal(e);t.ok?(x(),h("🗑️ Đã dọn dẹp xác vật nuôi","info")):h(t.msg,"error")}window.handleRemoveDeadAnimal=vn;function Sn(e){const t=GAME.cureAnimal(e);t.ok?(x(),h("💊 Đã tiêm thuốc trị bệnh và bảo vệ thành công!","success")):h(t.msg,"error")}window.handleCureAnimal=Sn;function $n(e){window.shopTab=e,document.querySelectorAll(".shop-tab").forEach(n=>{n.classList.remove("active","text-yellow-400","border-b-2","border-yellow-400"),n.classList.add("text-gray-400")});const t=document.getElementById(e==="buy"?"tabBuy":"tabSell");t&&(t.classList.add("active","text-yellow-400","border-b-2","border-yellow-400"),t.classList.remove("text-gray-400")),ct()}window.showShopTab=$n;function ct(){W();const e=document.getElementById("shopContent");e&&(window.shopTab==="buy"?e.innerHTML=ge():e.innerHTML=be())}window.renderShopContent=ct;function ge(){const e=[];Object.values(PLANTS_DATA).filter(i=>i.season===G.season).forEach(i=>{e.push({type:"seed",id:i.id,data:i})}),e.push({type:"animal",id:"chicken",data:{name:"Gà con",buy_price:100,emoji:"🐔"}}),e.push({type:"animal",id:"cow",data:{name:"Bò con",buy_price:200,emoji:"🐮"}}),[1,2,3].forEach(i=>{e.push({type:"fertilizer",id:i.toString(),data:FERTILIZER_DATA[i]})}),e.push({type:"pesticide",id:"pesticide",data:{name:"Thuốc trừ sâu",price:PESTICIDE_PRICE,emoji:"🧪"}}),e.push({type:"food",id:"bread",data:{name:"Bánh mì",price:1e3,emoji:"🍞",energy:10}}),e.push({type:"food",id:"noodle",data:{name:"Mì",price:1800,emoji:"🍜",energy:25}}),e.push({type:"food",id:"rice",data:{name:"Cơm",price:4800,emoji:"🍚",energy:50}}),e.push({type:"food",id:"poultry",data:{name:"Thức ăn gia cầm",price:50,emoji:"🌾",energy:0}}),e.push({type:"food",id:"livestock",data:{name:"Thức ăn gia súc",price:50,emoji:"🌾",energy:0}}),e.push({type:"medicine_animal",id:"medicine_animal",data:{name:"Thuốc thú y",price:50,emoji:"💊"}}),!window.selectedShopItemId&&e.length>0&&(window.selectedShopItemId=e[0].type+"_"+e[0].id);let t='<div class="w-full md:w-3/5 overflow-y-auto pr-2" style="max-height: 60vh;">';[{title:"🌱 Hạt giống",filter:i=>i.type==="seed"},{title:"🐔 Gia súc & Gia cầm",filter:i=>i.type==="animal"},{title:"🍞 Thực phẩm hồi năng lượng (Người)",filter:i=>i.type==="food"&&i.id!=="poultry"&&i.id!=="livestock"},{title:"🌾 Thức ăn vật nuôi & Hỗ trợ",filter:i=>i.type==="fertilizer"||i.type==="pesticide"||i.type==="medicine_animal"||i.id==="poultry"||i.id==="livestock"}].forEach(i=>{const a=e.filter(i.filter);a.length>0&&(t+=`<div class="font-bold text-yellow-400 mb-2 mt-4 first:mt-1 text-xs uppercase tracking-wider">${i.title}</div>`,a.forEach(l=>{const d=l.data,u=window.selectedShopItemId===`${l.type}_${l.id}`,c=d.price||d.buy_price||PESTICIDE_PRICE;let p="";l.type==="seed"?p=`Hạt giống · Mùa ${SEASON_LABELS[d.season]}`:l.type==="animal"?p="Vật nuôi nuôi ở Farm":l.type==="food"?l.id==="poultry"||l.id==="livestock"?p="Thức ăn cho vật nuôi":p=`Thực phẩm · Hồi +${d.energy}⚡`:l.type==="fertilizer"?p="Phân bón tăng trưởng":l.type==="pesticide"?p="Thuốc phòng trừ sâu hại":l.type==="medicine_animal"&&(p="Thuốc thú y trị bệnh"),t+=`
      ...
      <div class="bg-gray-800 p-3 rounded-lg border border-gray-700 text-sm space-y-2">
        ...
        <div class="flex justify-between border-b border-gray-700 pb-1"><span>Thời gian:</span> <span class="text-blue-400">${F(i.growth_time*6e4)}</span></div>
    ...
    `}else if(n.type==="animal"){const i=n.data,a=n.id==="chicken",l=a?200:400,d=a?`Gà con (Chuồng gia cầm, capacity: ${G.animals.filter(u=>u.type==="chicken").length}/${G.poultry_capacity})`:`Bò con (Chuồng gia súc, capacity: ${G.animals.filter(u=>u.type==="cow").length}/${G.livestock_capacity})`;s+=`
      <div class="text-center">
        <div class="text-6xl mb-2">${i.emoji}</div>
        <div class="text-xl font-bold text-yellow-400">${i.name}</div>
      ...
      <div class="bg-gray-800 p-3 rounded-lg border border-gray-700 text-xs space-y-2 leading-relaxed">
        ...
        <div class="text-[11px] text-gray-400 mt-1">💡 Cần cho ăn cứ mỗi 6 giờ bằng <b>${a?"thức ăn gia cầm":"thức ăn gia súc"}</b> (khi sinh lực <= 50%). Nếu sinh lực về 0 và không cho ăn trong 5 ngày, vật nuôi sẽ chết.</div>
      </div>
      <div class="mt-4 md:mt-auto flex flex-col gap-2">
    ...
    `}return s}window.renderShopItemDetails=vt;function ye(e){const t=document.getElementById("shopItemModal"),n=document.getElementById("shopItemModalContent");t&&n&&(n.innerHTML=vt(e),t.style.display="flex")}window.openShopItemModal=ye;function kn(){const e=document.getElementById("shopItemModal");e&&(e.style.display="none")}window.closeShopItemModal=kn;function Tn(e){window.selectedShopItemId=e,window.innerWidth<768?ye(e):ct()}window.selectShopItem=Tn;function be(){const e=G.inventory,t=Object.keys(e).filter(s=>e[s]>0&&(s.startsWith("harvest_")||s==="cheese"));if(t.length===0)return'<div class="text-center py-8 text-gray-400"><div class="text-4xl mb-2">🎒</div>Không có sản phẩm thu hoạch nào để bán</div>';let n='<div class="grid grid-cols-2 md:grid-cols-3 gap-3 p-1">';return t.forEach(s=>{let i=s,a=0,l="📦";if(s==="harvest_chicken_egg")i="Trứng gà",a=50,l="🥚";else if(s==="harvest_cow_milk")i="Sữa bò",a=500,l="🥛";else if(s.startsWith("harvest_")){const d=PLANTS_DATA[s.replace("harvest_","")];d&&(i=d.name,a=d.sell_price_per_yield,l=d.emoji)}else if(s.startsWith("fertilizer_")){const d=parseInt(s.replace("fertilizer_","")),u=FERTILIZER_DATA[d];u&&(i=u.name,a=Math.floor(u.price*.5),l=u.emoji)}else if(s==="pesticide")i="Thuốc trừ sâu",a=Math.floor(PESTICIDE_PRICE*.5),l="🧪";else if(s==="food_bread")i="Bánh mì",a=500,l="🍞";else if(s==="food_noodle")i="Mì",a=900,l="🍜";else if(s==="food_rice")i="Cơm",a=2400,l="🍚";else if(s==="food_poultry")i="Thức ăn gia cầm",a=25,l="🌾";else if(s==="food_livestock")i="Thức ăn gia súc",a=25,l="🌾";else if(s==="medicine_animal")i="Thuốc thú y",a=25,l="💊";else if(PLANTS_DATA[s]){const d=PLANTS_DATA[s];i=d.name+" (hạt giống)",a=Math.floor(d.buy_price*.5),l=d.emoji}else s==="cheese"&&(i="Phô mai",a=2500,l="🧀");n+=`
      <div class="relative bg-gray-800 border border-gray-700 rounded-2xl p-3 flex flex-col justify-between hover:border-gray-500 transition-all shadow-lg">
        ...
        <div class="flex flex-col gap-2 mt-auto">
          ...
          <div class="grid grid-cols-2 gap-1.5">
            <button class="btn btn-yellow text-[10px] sm:text-xs py-1.5 font-bold flex items-center justify-center gap-1 shadow-sm transition-all" onclick="handleShopSellCustom('${s}', ${e[s]})">Bán</button>
            <button class="btn btn-red text-[10px] sm:text-xs py-1.5 font-bold flex items-center justify-center gap-1 shadow-sm transition-all" onclick="shopSell('${s}', ${e[s]})">Bán hết</button>
          </div>
        </div>
      </div>
    `}),n+="</div>",n}window.renderSellTab=be;function An(e,t,n){const s=buyItem(e,t,n);if(!s.ok){h(s.msg,"error");return}W(),ct(),window.innerWidth<768&&document.getElementById("shopItemModal").style.display==="flex"&&(document.getElementById("shopItemModalContent").innerHTML=vt(window.selectedShopItemId)),h(`✅ Đã mua (${s.cost}🪙)`,"success")}window.shopBuy=An;function _e(e,t){let n=e;if(e==="harvest_chicken_egg")n="Trứng gà";else if(e==="harvest_cow_milk")n="Sữa bò";else if(e.startsWith("harvest_")){const i=PLANTS_DATA[e.replace("harvest_","")];i&&(n=i.name)}else if(e.startsWith("fertilizer_")){const i=parseInt(e.replace("fertilizer_","")),a=FERTILIZER_DATA[i];a&&(n=a.name)}else e==="pesticide"?n="Thuốc trừ sâu":e==="food_bread"?n="Bánh mì":e==="food_noodle"?n="Mì":e==="food_rice"?n="Cơm":e==="food_poultry"?n="Thức ăn gia cầm":e==="food_livestock"?n="Thức ăn gia súc":e==="medicine_animal"?n="Thuốc thú y":PLANTS_DATA[e]?n=PLANTS_DATA[e].name+" (hạt giống)":e==="cheese"&&(n="Phô mai");if(!confirm(`Bạn có chắc chắn muốn bán x${t} ${n} không?`))return;const s=sellItem(e,t);if(!s.ok){h(s.msg,"error");return}W(),ct(),h(`💰 Bán được ${s.revenue}🪙!`,"success")}window.shopSell=_e;function In(e,t,n){const s=document.getElementById(`sell_qty_${e}`);if(!s)return;let i=parseInt(s.value)||1;i=Math.max(1,Math.min(n,i+t)),s.value=i}window.adjustSellQty=In;function En(e,t){const n=document.getElementById(`sell_qty_${e}`);n&&(n.value=t)}window.setSellQtyMax=En;function Mn(e,t){const n=document.getElementById(`sell_qty_${e}`);if(!n)return;let s=parseInt(n.value);isNaN(s)||s<1||s>t&&(n.value=t)}window.validateSellQty=Mn;function jn(e,t){const n=document.getElementById(`sell_qty_${e}`);if(!n)return;let s=parseInt(n.value);if(isNaN(s)||s<1){h("❌ Số lượng bán không hợp lệ!","error");return}s>t&&(s=t),_e(e,s)}window.handleShopSellCustom=jn;window.selectedInventoryItem=null;function Bt(){const e=G.inventory,t=Object.keys(e).filter(l=>e[l]>0),n=document.getElementById("inventoryContent");if(!n)return;if(t.length===0){n.innerHTML='<div class="text-center py-8 text-gray-400"><div class="text-4xl mb-2">🎒</div>Túi trống</div>';return}(!window.selectedInventoryItem||!e[window.selectedInventoryItem])&&(window.selectedInventoryItem=t[0]);let s='<div class="w-full md:w-3/5 grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-2 content-start pr-2 overflow-y-auto" style="max-height: 50vh;">';t.forEach(l=>{let d=l,u="📦";if(l==="harvest_chicken_egg")d="Trứng gà",u="🥚";else if(l==="harvest_cow_milk")d="Sữa bò",u="🥛";else if(l.startsWith("harvest_")){const p=PLANTS_DATA[l.replace("harvest_","")];p&&(d=p.name,u=p.emoji)}else if(l.startsWith("fertilizer_")){const p=parseInt(l.replace("fertilizer_","")),f=FERTILIZER_DATA[p];f&&(d=f.name,u=f.emoji)}else if(l==="pesticide")d="Thuốc trừ sâu",u="🧪";else if(PLANTS_DATA[l]){const p=PLANTS_DATA[l];d=p.name,u=p.emoji}else l==="food_bread"?(d="Bánh mì",u="🍞"):l==="food_noodle"?(d="Mì",u="🍜"):l==="food_rice"?(d="Cơm",u="🍚"):l==="food_poultry"?(d="Thức ăn gia cầm",u="🌾"):l==="food_livestock"?(d="Thức ăn gia súc",u="🌾"):l==="medicine_animal"?(d="Thuốc thú y",u="💊"):l==="cheese"&&(d="Phô mai",u="🧀");const c=window.selectedInventoryItem===l;s+=`
    ...
    `;i+=`
      ...
      ${f}
      ${m}
    `}i+="</div>",n.innerHTML=`<div class="flex flex-col md:flex-row w-full">${s}${i}</div>`}window.renderInventoryContent=Bt;function Ln(e){window.selectedInventoryItem=e,Bt()}window.selectInventoryItem=Ln;function Dn(e,t){if(G.energy>=100){h("⚡ Năng lượng đã đầy!","info");return}if(!G.inventory[e]||G.inventory[e]<=0){h("❌ Không có vật phẩm này!","error");return}G.inventory[e]--,G.inventory[e]<=0&&delete G.inventory[e],G.energy=Math.min(100,G.energy+t),saveState(),W(),Bt(),h(`🍽️ Đã ăn, hồi phục +${t} ⚡!`,"success")}window.eatFood=Dn;function Nn(e,t){let n=e;if(e==="harvest_chicken_egg")n="Trứng gà";else if(e==="harvest_cow_milk")n="Sữa bò";else if(e.startsWith("harvest_")){const i=PLANTS_DATA[e.replace("harvest_","")];i&&(n=i.name)}else if(e.startsWith("fertilizer_")){const i=parseInt(e.replace("fertilizer_","")),a=FERTILIZER_DATA[i];a&&(n=a.name)}else e==="pesticide"?n="Thuốc trừ sâu":e==="food_bread"?n="Bánh mì":e==="food_noodle"?n="Mì":e==="food_rice"?n="Cơm":e==="food_poultry"?n="Thức ăn gia cầm":e==="food_livestock"?n="Thức ăn gia súc":e==="medicine_animal"?n="Thuốc thú y":PLANTS_DATA[e]?n=PLANTS_DATA[e].name+" (hạt giống)":e==="cheese"&&(n="Phô mai");if(!confirm(`Bạn có chắc chắn muốn vứt x${t} ${n} không?`))return;const s=GAME.discardItem(e,t);s.ok?(h(`🗑️ Đã vứt x${t} vật phẩm!`,"info"),G.inventory[e]||(window.selectedInventoryItem=null),x()):h(s.msg,"error")}window.handleDiscardItem=Nn;let et=null;function Gn(){et&&clearInterval(et),et=setInterval(()=>{const e=document.getElementById("viewTasks");if(!e||e.classList.contains("hidden")){xe();return}if(GAME.checkQuestCooldowns()){St();return}Cn()},1e3)}window.startTasksTimer=Gn;function xe(){et&&(clearInterval(et),et=null)}window.stopTasksTimer=xe;function Cn(){const e=Date.now();G.quests.forEach((t,n)=>{if(!t.cooldownUntil||t.cooldownUntil<=e)return;const s=document.getElementById(`quest_countdown_${n}`);if(!s)return;const i=t.cooldownUntil-e,a=Math.floor(i/6e4),l=Math.floor(i%6e4/1e3);s.textContent=`${a.toString().padStart(2,"0")}:${l.toString().padStart(2,"0")}`})}function St(){GAME.checkQuestCooldowns();const e=document.getElementById("tasksContent");if(!e)return;const t=Date.now();let n=`
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
  `;for(let s=0;s<3;s++){const i=G.quests[s];if(n+=`
    ...
    `,i.cooldownUntil&&i.cooldownUntil>t){const a=i.cooldownUntil-t,l=Math.floor(a/6e4),d=Math.floor(a%6e4/1e3),u=`${l.toString().padStart(2,"0")}:${d.toString().padStart(2,"0")}`;n+=`
  ...
  `,e.innerHTML=n}window.renderTasksContent=St;function Bn(e){if(!confirm("Bạn có chắc chắn muốn làm mới nhiệm vụ này? Bạn sẽ phải đợi 15 phút để nhận nhiệm vụ mới."))return;const t=GAME.resetQuest(e);t.ok?(h("🔄 Đã làm mới nhiệm vụ, vui lòng chờ 15 phút!","info"),St(),J()):h(t.msg,"error")}window.handleResetQuest=Bn;function Rn(e){const t=GAME.completeQuest(e);t.ok?(h(`🎉 Đã giao hàng thành công! (+${t.rewardGold}🪙)`,"success"),St(),W(),J()):h(t.msg,"error")}window.handleCompleteQuest=Rn;function Pn(){if(G.gold<1e5){h("❌ Không đủ vàng để mở khóa (Cần 100.000 🪙)!","error");return}if(confirm("Bạn có chắc chắn muốn dùng 100.000 🪙 để mở khóa Nhà sản xuất vật tư?")){const e=GAME.unlockProducer();e.ok?(h("🎉 Đã mở khóa Nhà sản xuất vật tư!","success"),Y(),W(),J()):h(e.msg,"error")}}window.handleUnlockProducer=Pn;function zn(e){const t=GAME.collectProducerSlot(e);t.ok?(h(`📥 Đã thu hoạch x${t.qty} ${t.emoji} ${t.name}!`,"success"),Y(),J()):h(t.msg,"error")}window.handleCollectProducer=zn;function we(e,t,n){const s=GAME.loadProducerSlot(e,t,n);s.ok?(h(`✅ Đã thêm x${n} vào máy sản xuất!`,"success"),slotSelectingItem[e]=!1,slotSelectedInput[e]=null,Y(),J()):h(s.msg,"error")}window.handleLoadProducer=we;let nt=null;function qn(){nt&&clearInterval(nt),nt=setInterval(()=>{const e=document.getElementById("viewProducer");if(!e||e.classList.contains("hidden")){ve();return}GAME.updateProducer(),Y()},1e3)}window.startProducerTimer=qn;function ve(){nt&&(clearInterval(nt),nt=null)}window.stopProducerTimer=ve;function Un(e){slotSelectingItem[e]=!0,slotSelectedInput[e]=null,Y()}window.openProducerSelect=Un;function Fn(e){slotSelectingItem[e]=!1,slotSelectedInput[e]=null,Y()}window.cancelProducerSelect=Fn;function Hn(e,t){slotSelectedInput[e]=t,Y()}window.selectProducerInput=Hn;function On(e,t){slotSelectingItem[e]=!0,slotSelectedInput[e]=t,Y()}window.openProducerAddMore=On;function Kn(e,t){const n=document.getElementById(`producer_qty_input_${e}`);n&&(n.value=t)}window.setProducerQtyInputValue=Kn;function Qn(e,t){const n=document.getElementById(`producer_qty_input_${e}`);if(!n)return;const s=parseInt(n.value);if(isNaN(s)||s<=0){h("❌ Số lượng nạp không hợp lệ!","error");return}if(t==="harvest_cow_milk"&&s%4!==0){h("❌ Số lượng sữa bò nạp vào phải là bội số của 4 (ví dụ: 4, 8, 12, ...)!","error");return}we(e,t,s)}window.confirmLoadProducerSlot=Qn;function Y(){const e=document.getElementById("producerContent");if(!e)return;if(!G.producerUnlocked){e.innerHTML=`
  ...
  `;for(let n=0;n<3;n++){const s=G.producerSlots[n];if(t+=`
    ...
    `,slotSelectingItem[n]){const i=G.inventory,a=Object.keys(i).filter(d=>i[d]<=0?!1:d==="harvest_cow_milk"||d.startsWith("harvest_")&&d!=="harvest_chicken_egg"),l=slotSelectedInput[n];if(!l)t+=`
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-3 bg-gray-950/40 p-2.5 rounded-xl border border-gray-800">
                ...
                <div>
                  ...
                  <div class="text-[10px] text-gray-500">Trong túi có: x${i[l]} | Sức chứa slot còn: ${b}</div>
                </div>
              </div>
        ...
        `}}else if(s.inputKey){const i=GAME.getProducerOutputInfo(s.inputKey),a=i&&i.inputRatio||1;let l=s.inputKey,d="📦";if(s.inputKey==="harvest_cow_milk")l="Sữa bò",d="🥛";else{const f=PLANTS_DATA[s.inputKey.replace("harvest_","")];f&&(l=f.name,d=f.emoji)}const u=i?i.time:3e5,c=Math.min(100,Math.floor(s.timeSpent/u*100));let p="";if(s.qtyLeft>0){const f=u-s.timeSpent,_=Math.floor(f/6e4),m=Math.floor(f%6e4/1e3);p=`<span class="text-xs text-yellow-500 font-bold font-mono">⏱️ ${`${_.toString().padStart(2,"0")}:${m.toString().padStart(2,"0")}`}</span>`}else p='<span class="text-xs text-green-400 font-bold">✓ Đã hoàn tất tất cả</span>';t+=`
        <div class="flex-1 flex flex-col justify-between">
          <div class="space-y-4">
  ...
  `,e.innerHTML=t}window.renderProducerContent=Y;window.G||Object.defineProperty(window,"G",{get(){return window.GAME?window.GAME.G:null},set(e){window.GAME&&(window.GAME.G=e)}});window.selectedPlot=null;window.currentZone=0;window.plantingPlotKey=null;window.selectedPlantId=null;window.selectedFert=0;window.fertilizePlotKey=null;window.selectedFertilizerType=0;window.shopTab="buy";window.autoRefreshTimer=null;window.selectedShopItemId=null;window.currentModalScreen="details";window.slotSelectingItem=[!1,!1,!1];window.slotSelectedInput=[null,null,null];window.currentFarmTab="crops";document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("seasonSelect");e&&G&&(e.value=G.season,e.addEventListener("change",t=>{GAME.changeSeason(t.target.value),x(),h(`Đổi sang ${SEASON_LABELS[G.season]}`,"info")})),x(),G&&G.needsStartSeason&&ke(),Se()});function Se(){window.autoRefreshTimer&&clearInterval(window.autoRefreshTimer),window.autoRefreshTimer=setInterval(()=>{const e=GAME.updateSeasonClock(),t=GAME.lazyUpdateAll();W(),Pt(),zt(),dt(),J(),t&&h("🔄 Trạng thái nông trại đã cập nhật!","info"),e&&h(`🍂 Chuyển sang ${SEASON_LABELS[G.season]}`,"success");const n=document.getElementById("refreshStatus");n&&(n.textContent=`🔄 Sync: ${new Date().toLocaleTimeString("vi")}`)},1e4)}window.startAutoRefresh=Se;function x(){!window.GAME||!G||(GAME.updateSeasonClock(),GAME.lazyUpdateAll(),Rt(),dt(),J(),W(),Pt(),zt())}window.render=x;function Rt(){const e=[{id:"crops",label:"🏡 Trồng trọt"},{id:"poultry",label:"🐔 Gia cầm"},{id:"livestock",label:"🐮 Gia súc"}],t=document.getElementById("farmSubTabs");t&&(t.innerHTML=e.map(n=>`
    <div class="zone-tab ${n.id===window.currentFarmTab?"active":""}" onclick="switchFarmTab('${n.id}')">
      ${n.label}
    </div>
  `).join(""))}window.renderFarmSubTabs=Rt;function Vn(e){window.currentFarmTab=e,window.selectedPlot=null,Rt(),dt()}window.switchFarmTab=Vn;function dt(){const e=document.getElementById("farmGridContainer");e&&(window.currentFarmTab==="crops"?e.innerHTML=te():window.currentFarmTab==="poultry"?e.innerHTML=jt("poultry"):window.currentFarmTab==="livestock"&&(e.innerHTML=jt("livestock")))}window.renderFarmGridArea=dt;function Zn(e){window.selectedPlot=e,window.currentModalScreen="details";const t=document.getElementById("plotModal");t&&(t.style.display="flex"),ot()}window.selectPlotCell=Zn;function tt(){window.selectedPlot=null,window.currentModalScreen="details";const e=document.getElementById("plotModal");e&&(e.style.display="none"),dt()}window.closePlotModal=tt;function J(){ee(),window.selectedPlot&&window.currentModalScreen==="details"&&ot()}window.renderSidebar=J;function F(e){if(e<=0)return"0ph";const t=Math.floor(e/6e4),n=Math.floor(t/1440),s=Math.floor(t%1440/60),i=t%60;if(n>0){let a=[`${n}d`];return s>0&&a.push(`${s}h`),i>0&&a.push(`${i}m`),a.join(" ")}else return s>0?i>0?`${s}h ${i}m`:`${s}h`:`${i}m`}window.formatTime=F;function h(e,t="info"){const n=document.getElementById("toast");if(!n)return;const s=document.createElement("div");s.className=`toast-item ${t}`,s.textContent=e,n.appendChild(s),setTimeout(()=>s.remove(),3500)}window.toast=h;function W(){if(!G)return;const e=document.getElementById("goldDisplay");e&&(e.textContent=Math.floor(G.gold));const t=document.getElementById("energyDisplay");t&&(t.textContent=Math.floor(G.energy))}window.updateGold=W;function Pt(){if(!G)return;const e=document.getElementById("seasonSelect");e&&(e.value=G.season)}window.updateSeasonDisplay=Pt;function zt(){if(!G)return;const e=document.getElementById("dayDisplay");e&&(e.textContent=`${GAME.getDayOfSeason(G.game_day)}/30`,qt())}window.updateDayDisplay=zt;function qt(){if(!G)return;const e=document.getElementById("gameClockDisplay");if(e){const t=Date.now()-G.lastDayTick,n=Math.floor(t/36e5)%24,s=Math.floor(t%36e5/6e4);e.textContent=`${n.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}`}}window.updateClockDisplay=qt;setInterval(qt,1e3);document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".modal-overlay").forEach(e=>{e.addEventListener("click",t=>{t.target===e&&(e.style.display="none")})})});function $e(e){document.querySelectorAll(".app-view").forEach(s=>s.classList.add("hidden"));const t=document.getElementById(e);t&&t.classList.remove("hidden"),document.querySelectorAll(".nav-btn").forEach(s=>{s.classList.remove("text-yellow-400"),s.classList.add("text-gray-400")});const n=document.getElementById("nav-"+e);n&&(n.classList.add("text-yellow-400"),n.classList.remove("text-gray-400")),typeof closeShopItemModal=="function"&&closeShopItemModal(),e==="viewShop"?(window.stopTasksTimer&&window.stopTasksTimer(),window.stopProducerTimer&&window.stopProducerTimer(),typeof window.shopTab>"u"||!window.shopTab?window.showShopTab("buy"):window.renderShopContent()):e==="viewInventory"?(window.stopTasksTimer&&window.stopTasksTimer(),window.stopProducerTimer&&window.stopProducerTimer(),window.renderInventoryContent()):e==="viewTasks"?(window.stopProducerTimer&&window.stopProducerTimer(),window.renderTasksContent(),window.startTasksTimer&&window.startTasksTimer()):e==="viewProducer"?(window.stopTasksTimer&&window.stopTasksTimer(),window.renderProducerContent(),window.startProducerTimer&&window.startProducerTimer()):(window.stopTasksTimer&&window.stopTasksTimer(),window.stopProducerTimer&&window.stopProducerTimer())}window.switchView=$e;function Yn(){confirm("Bạn có muốn bắt đầu lại hoặc nạp file save khác? Dữ liệu hiện tại sẽ bị xóa sạch.")&&(GAME.resetGame(),x(),h("🔄 Hãy chọn màn mới hoặc nạp file save","info"))}window.confirmResetGame=Yn;function ke(){const e=document.getElementById("startSeasonModal");e&&(e.style.display="flex",Ae())}window.openStartSeasonModal=ke;function Te(){const e=document.getElementById("startSeasonModal");e&&(e.style.display="none")}window.closeStartSeasonModal=Te;function Ae(){const e=document.getElementById("startSeasonContent");e&&(e.innerHTML=`
  ...
  `)}window.renderStartSeasonContent=Ae;function Wn(e){GAME.setStartSeason(e)}window.setStartSeason=Wn;function Jn(){const e=localStorage.getItem("mangak_farm_v1");if(!e){h("Chưa có dữ liệu để xuất!","error");return}const t=new Blob([e],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`mangak_farm_save_${Date.now()}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(n),h("💾 Đã xuất file save thành công!","success")}window.exportSave=Jn;function Xn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=function(s){try{const i=s.target.result,a=JSON.parse(i);if(typeof a!="object"||!a.plots)throw new Error("Invalid save format");localStorage.setItem("mangak_farm_v1",i);const l=GAME.loadState();GAME.G=l,GAME.syncUnlockedPlots(),x(),Te(),h("✅ Đã nạp file save thành công!","success")}catch(i){h("❌ File save không hợp lệ!","error"),console.error(i)}},n.readAsText(t)}window.handleImportSave=Xn;console.log("🌾 Mangak Farm UI Modules initialized successfully.");
